class CylinderTest
{
    ...
    public static void main(String[] args)
    {
        ...
        System.out.println("The total area of the cylinder with radius = " + myCylinder.getRadius() + " and height "+ myCylinder.getHeight() + " is " + myCylinder.circleArea() );
        ...
        //Testing the setRadius, setHeight and getRadius and getHeight                                                  //Success
